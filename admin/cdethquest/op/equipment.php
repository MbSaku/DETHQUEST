...
?>
  ...
  <div class="editiontitle"><?php echo Equipment_items; ?></div>
  <?php
  $query = 'select id from '.mod.'deth_item_equipment where name like "%'.$filter.'%" order by price asc, premium asc, name asc';
  ...
  and isset( $_POST['intelligence'] ) ){
    ...
    $item->setMaxhealth( $_POST['health'] );
    $item->setSpeed( $_POST['speed'] );
    $item->setStrength( $_POST['strength'] );
    $item->setDexterity( $_POST['dexterity'] );
    $item->setConstitution( $_POST['constitution'] );
    $item->setIntelligence( $_POST['intelligence'] );
    if( isset( $_POST['permanent'] ) ){
      $item->setPermanent( true );
    }else{
      $item->setPermanent( false );
    }
  ...
  <form name="editrace" onsubmit="event.preventDefault(); backend.post(this);" enctype="multipart/form-data" method="post" action="">
    ...
    <div class="edblock">
      ...
      <p class="pinput"><input type="checkbox" name="permanent" <?php
    ...
    <div class="edblock">
      <p class="pinput"><?php echo Health_boost ?>:<br>
      <input type="number" name="health" value="<?php echo $item->getMaxhealth(); ?>" style="width:6em"></p>
      <p class="pinput"><?php echo Speed_boost ?>:<br>
      <input type="number" name="speed" value="<?php echo $item->getSpeed(); ?>" style="width:6em"></p>
      <p class="pinput"><?php echo Strength_boost ?>:<br>
      <input type="number" name="strength" value="<?php echo $item->getStrength(); ?>" style="width:6em"></p>
      <p class="pinput"><?php echo Dexterity_boost ?>:<br>
      <input type="number" name="dexterity" value="<?php echo $item->getDexterity(); ?>" style="width:6em"></p>
      <p class="pinput"><?php echo Constitution_boost ?>:<br>
      <input type="number" name="constitution" value="<?php echo $item->getConstitution(); ?>" style="width:6em"></p>
      <p class="pinput"><?php echo Intelligence_boost ?>:<br>
      <input type="number" name="intelligence" value="<?php echo $item->getIntelligence(); ?>" style="width:6em"></p>
    </div>
